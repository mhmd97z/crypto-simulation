...
Q31a_txout_scriptPubKey = [
        OP_DEPTH, 3, OP_EQUAL, OP_IF, 2, faraz_public_key, ata_public_key, 2, OP_CHECKMULTISIG, OP_ELSE, 1,
        faraz_public_key, ata_public_key, 2, OP_CHECKMULTISIGVERIFY, 3, shareholder1_public_key,
        shareholder2_public_key, shareholder3_public_key, shareholder4_public_key,
        shareholder5_public_key, 5, OP_CHECKMULTISIG, OP_ENDIF
    ]
